...
|---|:---:|:---:|:---:|---|---|
| evm-project-tool-infrastructure | `Pendiente` | `Creado — pendiente aprobación` | `D` | `evm-project-tool-infrastructure/summary.md` | `../../backend/evm-project-tool-backend/summary.md`, `../../frontend/evm-project-tool-frontend/summary.md` |
